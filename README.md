...
<ol>
    ...
    <img src="Assignment1/Snapshots/Q1.png" alt="Project Screenshot" width="600">
    <li>MPI program to send and receive message using MPI_Send() and MPI_Recv()</li>
    <img src="Assignment1/Snapshots/Q2.png" alt="Project Screenshot" width="600">
    <li>MPI program to send and receive message dynamically</li>
    <img src="Assignment1/Snapshots/Q3.png" alt="Project Screenshot" width="600">
...
<ol>
    ...
    <img src="Assignment2/Snapshots/Q1.png" alt="Project Screenshot" width="600">
    <li>MatrixMultiplication time comparison for sequential and parallel</li>
    <img src="Assignment2/Snapshots/Q2.png" alt="Project Screenshot" width="600">
    <li>Even-Odd sorting </li>
    <img src="Assignment1/Snapshots/Q3.png" alt="Project Screenshot" width="600">
    <li>Heat Distribution Simulation</li>
    <!-- <img src="Assignment1/Snapshots/Q1.png" alt="Project Screenshot" width="600"> -->
    <li>Parallel Reduction using MPI</li>
    <img src="Assignment2/Snapshots/Q5.png" alt="Project Screenshot" width="600">
    <li>Parallel Dot Product using MPI</li>
    <img src="Assignment2/Snapshots/Q6.png" alt="Project Screenshot" width="600">
</ol>